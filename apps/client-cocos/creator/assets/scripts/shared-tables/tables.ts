...
,
  constants: {
  "version": 1,
  "sourceDoc": "docs/M0-数值模型-三曲线调参表.md §2 / docs/技术架构与模块规划 v1.0 §5.3 / docs/数据配置表结构设计 §3",
  "entries": [
    {
      "key": "CFG_R0",
      "value": 100,
  ...
  "entries": [
    ...
    { "type": "canteen",    "level": 3, "cost": { "gold": 1000 }, "capacity": 18 },
    { "type": "canteen",    "level": 4, "cost": { "gold": 2500 }, "capacity": 24 },
    { "type": "canteen",    "level": 5, "cost": { "gold": 5000 }, "capacity": 30 },
    { "type": "warehouse",  "level": 1, "cost": { "gold": 0 },    "capacity": 5000 },
    { "type": "warehouse",  "level": 2, "cost": { "gold": 800 },  "capacity": 12000 },
    { "type": "warehouse",  "level": 3, "cost": { "gold": 2500 }, "capacity": 30000 },
...
,
  ...
  "entries": [
    { "id": "evt_tut_fortify", "ver": 1, "type": "scripted", "triggerDay": 0, "title": "门口的抓痕", "weight": 0, "cooldownDays": 0, "maxPerRun": 0, "text": "门板上有新鲜的抓痕……趁天还没黑，加固它。", "options": [ { "label": "加固门（教学引导）", "outcomes": [ { "p": 1.0, "text": "门板吱呀作响，但结实了。", "effects": [] } ] } ] },
    { "id": "evt_tut_firstnight", "ver": 1, "type": "scripted", "triggerDay": 0, "title": "第 1 夜动员", "weight": 0, "cooldownDays": 0, "maxPerRun": 0, "text": "入夜前，把有限的人手布到最可能有问题的位置。", "options": [ { "label": "布防引导", "outcomes": [ { "p": 1.0, "text": "夜色压下来，楼里安静得能听见心跳。", "effects": [] } ] } ] },
    { "id": "evt_tut_rescue", "ver": 1, "type": "scripted", "triggerDay": 1, "title": "隔壁的呼救", "weight": 0, "cooldownDays": 0, "maxPerRun": 0, "text": "「救命——还有人吗！」", "options": [ { "label": "派主角去救", "outcomes": [ { "p": 1.0, "text": "拖回来一个浑身发抖的幸存者。", "effects": [ { "op": "SPAWN_TENANT", "quality": "N" } ] } ] } ] },
    { "id": "evt_tut_referral", "ver": 1, "type": "scripted", "triggerDay": 2, "title": "老张说：我还有俩邻居", "weight": 0, "cooldownDays": 0, "maxPerRun": 0, "text": "「他们人不错，就在下一条街。」", "options": [ { "label": "接引", "outcomes": [ { "p": 1.0, "text": "一老一少，行李都没丢。", "effects": [ { "op": "SPAWN_TENANT", "quality": "N" }, { "op": "SPAWN_TENANT", "quality": "N" } ] } ] } ] },
    { "id": "evt_tut_broadcast", "ver": 1, "type": "scripted", "triggerDay": 2, "title": "广播站第一通广播", "weight": 0, "cooldownDays": 0, "maxPerRun": 0, "text": "「这里是 7 号楼，我们收留活人。」", "options": [ { "label": "招募", "outcomes": [ { "p": 1.0, "text": "当天下午，门口排起了队。", "effects": [ { "op": "ADD_RES", "res": "food", "n": -100 }, { "op": "SPAWN_TENANT", "quality": "N" }, { "op": "SPAWN_TENANT", "quality": "N" } ] } ] } ] },
    { "id": "evt_tut_bills", "ver": 1, "type": "scripted", "triggerDay": 3, "title": "第一笔「物业费」", "weight": 0, "cooldownDays": 0, "maxPerRun": 0, "text": "住进来可以，但规矩得立：按天交租。", "options": [ { "label": "收租", "outcomes": [ { "p": 1.0, "text": "金币入袋的声音，比枪声好听。", "effects": [ { "op": "ADD_GOLD", "n": 300 } ] } ] } ] },
    { "id": "evt_tut_panic", "ver": 1, "type": "scripted", "triggerDay": 5, "title": "有人半夜偷哭", "weight": 0, "cooldownDays": 0, "maxPerRun": 0, "text": "恐慌像霉斑，会顺着楼板蔓延。", "options": [ { "label": "逐户安抚", "outcomes": [ { "p": 1.0, "text": "哭声停了。人心，也是要修的。", "effects": [ { "op": "ADD_PANIC", "n": -10 }, { "op": "SET_FLAG", "key": "orderIntro", "v": 1 } ] } ] } ] },
    { "id": "evt_tut_omen", "ver": 1, "type": "scripted", "triggerDay": 6, "title": "风向不对", "weight": 0, "cooldownDays": 0, "maxPerRun": 0, "text": "狗不叫了。风里有铁锈味。", "options": [ { "label": "登高观星", "outcomes": [ { "p": 1.0, "text": "月亮是红的。明天，是血月。", "effects": [ { "op": "SET_FLAG", "key": "bloodmoonForetold", "v": 1 } ] } ] } ] },
    ...
    { "id": "evt_knock_001", "ver": 1, "type": "choice", "title": "深夜敲门人", "weight": 100, "cooldownDays": 5, "maxPerRun": 2, "prereq": { "dayMin": 3 }, "text": "「咚、咚、咚。」深夜的敲门声比怪物的嚎叫更瘆人。", "options": [
      ...
      { "label": "隔门询问", "outcomes": [ { "p": 1.0, "text": "对话几句后脚步声远去。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": 1 } ] } ] },
      { "label": "无视", "outcomes": [ { "p": 1.0, "text": "敲门声停了。你有点后悔。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": -1 } ] } ] } ] },
    { "id": "evt_grain_002", "ver": 1, "type": "choice", "title": "邻居偷粮", "weight": 90, "cooldownDays": 7, "maxPerRun": 2, "prereq": { "dayMin": 3 }, "text": "仓库少了两箱罐头，有人看见三楼的王磊昨晚鬼鬼祟祟。", "options": [
      { "label": "公审", "outcomes": [ { "p": 1.0, "text": "秩序立住了，但人心惶惶。", "effects": [ { "op": "ADD_PANIC", "n": 8 }, { "op": "SET_FLAG", "key": "order", "v": 1 } ] } ] },
      { "label": "私了", "outcomes": [ { "p": 1.0, "text": "他交回了一部分，这事翻篇。", "effects": [ { "op": "ADD_RES", "res": "food", "n": 100 } ] } ] },
      { "label": "放任", "outcomes": [ { "p": 1.0, "text": "仓库的锁形同虚设。", "effects": [ { "op": "ADD_PANIC", "n": 5 }, { "op": "SET_FLAG", "key": "order", "v": -1 } ] } ] } ] },
    { "id": "evt_box_003", "ver": 1, "type": "choice", "title": "阳台物资箱", "weight": 85, "cooldownDays": 5, "maxPerRun": 2, "prereq": {}, "text": "六楼阳台吊下来一个密封箱，绳子上系着字条：「给有缘人」。", "options": [
      { "label": "独占", "outcomes": [ { "p": 1.0, "text": "罐头与净水，全收。", "effects": [ { "op": "ADD_RES", "res": "food", "n": 300 }, { "op": "SET_FLAG", "key": "reputation", "v": -1 } ] } ] },
      { "label": "平分", "outcomes": [ { "p": 1.0, "text": "按户分发，楼里多了些暖意。", "effects": [ { "op": "ADD_PANIC", "n": -5 }, { "op": "SET_FLAG", "key": "reputation", "v": 1 } ] } ] },
      { "label": "换情报", "outcomes": [ { "p": 1.0, "text": "对面楼的眼线给了份巡逻图。", "effects": [ { "op": "SET_FLAG", "key": "intel", "v": 1 } ] } ] } ] },
    { "id": "evt_rent_004", "ver": 1, "type": "choice", "title": "老周欠租", "weight": 80, "cooldownDays": 7, "maxPerRun": 2, "prereq": { "dayMin": 5 }, "text": "老周蹲在门口抽烟：「媳妇病着，这个月……宽限几天？」", "options": [
      { "label": "免租", "outcomes": [ { "p": 1.0, "text": "老周红着眼眶连声道谢。", "effects": [ { "op": "SET_FLAG", "key": "mood", "v": 1 }, { "op": "SET_FLAG", "key": "reputation", "v": 1 } ] } ] },
      { "label": "照收", "outcomes": [ { "p": 1.0, "text": "规矩就是规矩。", "effects": [ { "op": "ADD_GOLD", "n": 500 } ] } ] },
      { "label": "驱赶", "outcomes": [ { "p": 1.0, "text": "行李被扔下楼，楼里没人说话。", "effects": [ { "op": "ADD_GOLD", "n": 200 }, { "op": "SET_FLAG", "key": "reputation", "v": -1 } ] } ] } ] },
    { "id": "evt_hoard_005", "ver": 1, "type": "choice", "title": "囤积者老李", "weight": 70, "cooldownDays": 10, "maxPerRun": 2, "prereq": { "dayMin": 6 }, "text": "老李屋里堆满了物资，楼下却有人在挨饿。", "options": [
      { "label": "征用", "outcomes": [ { "p": 1.0, "text": "物资充公，老李绝食抗议。", "effects": [ { "op": "ADD_RES", "res": "food", "n": 400 }, { "op": "ADD_PANIC", "n": 8 } ] } ] },
      { "label": "分成", "outcomes": [ { "p": 1.0, "text": "各让一步，仓库进账一半。", "effects": [ { "op": "ADD_RES", "res": "food", "n": 200 } ] } ] },
      { "label": "放任", "outcomes": [ { "p": 1.0, "text": "秩序哨声在走廊回荡。", "effects": [ { "op": "SET_FLAG", "key": "order", "v": -1 } ] } ] } ] },
    { "id": "evt_dog_006", "ver": 1, "type": "choice", "title": "凌晨的狗吠", "weight": 65, "cooldownDays": 7, "maxPerRun": 2, "prereq": {}, "text": "巷子里有条土狗，叫法很有规律——像在报信。", "options": [
      { "label": "收留", "outcomes": [ { "p": 1.0, "text": "狗拴在一层大厅，夜里耳朵比人灵。", "effects": [ { "op": "GRANT_BUFF", "buff": "warnDog", "days": 3 } ] } ] },
      { "label": "驱赶", "outcomes": [ { "p": 1.0, "text": "狗跑了，夜里静得发慌。", "effects": [ { "op": "ADD_PANIC", "n": 5 } ] } ] },
      { "label": "无视", "outcomes": [ { "p": 1.0, "text": "狗叫了一整夜。", "effects": [ { "op": "ADD_PANIC", "n": 3 } ] } ] } ] },
    { "id": "evt_generator_007", "ver": 1, "type": "choice", "title": "柴油发电机", "weight": 70, "cooldownDays": 10, "maxPerRun": 2, "prereq": { "dayMin": 5 }, "text": "隔壁楼捡来一台柴油发电机，开口就要分着用。", "options": [
      { "label": "小区共用", "outcomes": [ { "p": 1.0, "text": "全楼灯火通明，恐慌消散不少。", "effects": [ { "op": "ADD_GOLD", "n": -300 }, { "op": "ADD_PANIC", "n": -8 } ] } ] },
      { "label": "自家备用", "outcomes": [ { "p": 1.0, "text": "发电机锁进了你家储物间。", "effects": [ { "op": "GRANT_BUFF", "buff": "power", "days": 2 } ] } ] },
      { "label": "出租", "outcomes": [ { "p": 1.0, "text": "按小时计费，生意兴隆。", "effects": [ { "op": "ADD_GOLD", "n": 400 } ] } ] } ] },
    { "id": "evt_divorce_008", "ver": 1, "type": "choice", "title": "二楼夫妻吵架", "weight": 60, "cooldownDays": 10, "maxPerRun": 2, "prereq": {}, "text": "摔碗声隔着楼板都能听见。", "options": [
      { "label": "上门调解", "outcomes": [ { "p": 1.0, "text": "两口子和好，还硬塞了两条烟。", "effects": [ { "op": "ADD_PANIC", "n": -5 }, { "op": "SET_FLAG", "key": "reputation", "v": 1 } ] } ] },
      { "label": "不掺和", "outcomes": [ { "p": 1.0, "text": "吵吧，日子还长。", "effects": [ { "op": "ADD_PANIC", "n": 3 } ] } ] },
      { "label": "趁机收房", "outcomes": [ { "p": 1.0, "text": "房子到手，但你成了楼里的谈资。", "effects": [ { "op": "ADD_GOLD", "n": 600 }, { "op": "SET_FLAG", "key": "reputation", "v": -1 } ] } ] } ] },
    { "id": "evt_slingshot_009", "ver": 1, "type": "choice", "title": "孩子的弹弓", "weight": 55, "cooldownDays": 10, "maxPerRun": 2, "prereq": {}, "text": "五楼的孩子拿弹弓打路灯，碎石乱飞。", "options": [
      { "label": "没收", "outcomes": [ { "p": 1.0, "text": "孩子哭了半天，家长脸色难看。", "effects": [ { "op": "SET_FLAG", "key": "mood", "v": -1 } ] } ] },
      { "label": "教导", "outcomes": [ { "p": 1.0, "text": "孩子成了楼顶的瞭望哨。", "effects": [ { "op": "GRANT_BUFF", "buff": "sentryKid", "days": 3 } ] } ] },
      { "label": "放任", "outcomes": [ { "p": 1.0, "text": "玻璃又碎了一块。", "effects": [ { "op": "ADD_PANIC", "n": 5 } ] } ] } ] },
    { "id": "evt_medicine_010", "ver": 1, "type": "choice", "title": "最后一批抗生素", "weight": 75, "cooldownDays": 10, "maxPerRun": 2, "prereq": { "dayMin": 6 }, "text": "医务室只剩最后一板抗生素，三个人在排队。", "options": [
      { "label": "重患先得", "outcomes": [ { "p": 1.0, "text": "该救的救了，人心安稳。", "effects": [ { "op": "ADD_PANIC", "n": -5 } ] } ] },
      { "label": "贡献者先得", "outcomes": [ { "p": 1.0, "text": "多劳多得，站岗的劲头更足了。", "effects": [ { "op": "GRANT_BUFF", "buff": "contrib", "days": 3 } ] } ] },
      { "label": "抽签", "outcomes": [ { "p": 1.0, "text": "命运面前人人平等，情绪意外平稳。", "effects": [ { "op": "SET_FLAG", "key": "mood", "v": 1 } ] } ] } ] },
    { "id": "evt_rumor_011", "ver": 1, "type": "choice", "title": "「明天怪不来了」", "weight": 70, "cooldownDays": 7, "maxPerRun": 2, "prereq": {}, "text": "不知道谁传的：永夜要结束了，怪物明天就不来了。", "options": [
      { "label": "辟谣", "outcomes": [ { "p": 1.0, "text": "大喇叭广播了三遍，谣言止住。", "effects": [ { "op": "ADD_PANIC", "n": -6 } ] } ] },
      { "label": "利用", "outcomes": [ { "p": 1.0, "text": "「末日保险」卖得飞起。", "effects": [ { "op": "ADD_GOLD", "n": 300 }, { "op": "SET_FLAG", "key": "trust", "v": -1 } ] } ] },
      { "label": "无视", "outcomes": [ { "p": 1.0, "text": "有人真的不设防了。", "effects": [ { "op": "ADD_PANIC", "n": 4 } ] } ] } ] },
    { "id": "evt_note_012", "ver": 1, "type": "choice", "title": "门缝里的纸条", "weight": 65, "cooldownDays": 7, "maxPerRun": 2, "prereq": { "dayMin": 4 }, "text": "纸条上画着一个箭头，指向地下室的通风井。", "options": [
      ...
      { "label": "置之不理", "outcomes": [ { "p": 1.0, "text": "纸条在门缝里发黄。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": 0 } ] } ] },
      { "label": "烧掉", "outcomes": [ { "p": 1.0, "text": "省得夜里胡思乱想。", "effects": [ { "op": "ADD_PANIC", "n": 2 } ] } ] } ] },
    { "id": "evt_birthday_013", "ver": 1, "type": "choice", "title": "楼里第一个生日", "weight": 60, "cooldownDays": 14, "maxPerRun": 2, "prereq": {}, "text": "今天是小雨的八岁生日，蛋糕是不可能的。", "options": [
      { "label": "办派对", "outcomes": [ { "p": 1.0, "text": "搪瓷缸碰在一起，像过年的声音。", "effects": [ { "op": "ADD_RES", "res": "food", "n": -200 }, { "op": "SET_FLAG", "key": "mood", "v": 1 } ] } ] },
      { "label": "取消", "outcomes": [ { "p": 1.0, "text": "孩子没哭，大人心里不是滋味。", "effects": [ { "op": "ADD_PANIC", "n": 3 } ] } ] },
      { "label": "双份口粮", "outcomes": [ { "p": 1.0, "text": "全楼都跟着沾了光。", "effects": [ { "op": "ADD_RES", "res": "food", "n": -300 }, { "op": "ADD_PANIC", "n": -5 } ] } ] } ] },
    { "id": "evt_thief_014", "ver": 1, "type": "choice", "title": "外楼的窃贼", "weight": 65, "cooldownDays": 10, "maxPerRun": 2, "prereq": { "dayMin": 5 }, "text": "巡逻队逮了个现形，人赃并获。", "options": [
      { "label": "公审", "outcomes": [ { "p": 1.0, "text": "秩序立威，围观者噤声。", "effects": [ { "op": "SET_FLAG", "key": "order", "v": 1 }, { "op": "ADD_PANIC", "n": 4 } ] } ] },
      ...
      { "label": "放走换情报", "outcomes": [ { "p": 1.0, "text": "他画了张怪物的活动图。", "effects": [ { "op": "SET_FLAG", "key": "intel", "v": 1 } ] } ] } ] },
    { "id": "evt_rat_015", "ver": 1, "type": "choice", "title": "仓库鼠患", "weight": 60, "cooldownDays": 10, "maxPerRun": 2, "prereq": {}, "text": "麻袋上全是齿印，粮仓成了鼠窝。", "options": [
      { "label": "养猫", "outcomes": [ { "p": 1.0, "text": "巷子里讨来一只狸花，鼠患渐消。", "effects": [ { "op": "ADD_RES", "res": "food", "n": -100 }, { "op": "GRANT_BUFF", "buff": "cat", "days": 7 } ] } ] },
      { "label": "投药", "outcomes": [ { "p": 1.0, "text": "死老鼠清理了一簸箕，也误伤了两袋米。", "effects": [ { "op": "ADD_RES", "res": "food", "n": -300 } ] } ] },
      { "label": "改造货架", "outcomes": [ { "p": 1.0, "text": "建材又花了一笔，但一劳永逸。", "effects": [ { "op": "ADD_RES", "res": "material", "n": -250 } ] } ] } ] },
    { "id": "evt_radio_016", "ver": 1, "type": "choice", "title": "外界的广播", "weight": 60, "cooldownDays": 14, "maxPerRun": 2, "prereq": { "dayMin": 7 }, "text": "电台里循环播放着撤离点的坐标，真假难辨。", "options": [
      { "label": "回应", "outcomes": [ { "p": 1.0, "text": "Morse 码回了三短三长，楼里士气一振。", "effects": [ { "op": "SET_FLAG", "key": "mood", "v": 1 } ] } ] },
      { "label": "保持静默", "outcomes": [ { "p": 1.0, "text": "枪打出头鸟。", "effects": [ { "op": "SET_FLAG", "key": "order", "v": 1 } ] } ] },
      { "label": "伪造回应", "outcomes": [ { "p": 1.0, "text": "骗到了一批空投物资，但有人起了疑心。", "effects": [ { "op": "ADD_GOLD", "n": 500 }, { "op": "SET_FLAG", "key": "trust", "v": -1 } ] } ] } ] },
    { "id": "evt_deadbeat_017", "ver": 1, "type": "choice", "title": "拒租的刺头", "weight": 70, "cooldownDays": 10, "maxPerRun": 2, "prereq": { "dayMin": 6 }, "text": "四楼的刺头把房租拍在地上：「爱要不要。」", "options": [
      { "label": "宽限", "outcomes": [ { "p": 1.0, "text": "他反而不好意思了。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": 1 } ] } ] },
      { "label": "断供", "outcomes": [ { "p": 1.0, "text": "第三天，金币和道歉一起送来。", "effects": [ { "op": "ADD_GOLD", "n": 800 }, { "op": "ADD_PANIC", "n": 8 } ] } ] },
      { "label": "驱逐", "outcomes": [ { "p": 1.0, "text": "行李滚下楼梯，楼里一片肃静。", "effects": [ { "op": "ADD_GOLD", "n": 400 }, { "op": "SET_FLAG", "key": "reputation", "v": -1 } ] } ] } ] },
    { "id": "evt_deed_018", "ver": 1, "type": "choice", "title": "归来的「房东」", "weight": 50, "cooldownDays": 14, "maxPerRun": 2, "prereq": { "dayMin": 8 }, "text": "一个西装革履的男人举着房产证：「这栋楼，是我的。」", "options": [
      { "label": "共治分成", "outcomes": [ { "p": 1.0, "text": "他入伙了，带来一笔启动金。", "effects": [ { "op": "ADD_GOLD", "n": 1000 }, { "op": "SET_FLAG", "key": "mood", "v": -1 } ] } ] },
      ...
      { "label": "认栽补偿", "outcomes": [ { "p": 1.0, "text": "破财免灾。", "effects": [ { "op": "ADD_GOLD", "n": -500 } ] } ] } ] },
    { "id": "evt_nightshift_019", "ver": 1, "type": "choice", "title": "谁值夜班", "weight": 65, "cooldownDays": 7, "maxPerRun": 2, "prereq": {}, "text": "守夜表贴出来三天，名字栏还是空白。", "options": [
      { "label": "轮班", "outcomes": [ { "p": 1.0, "text": "公平，但每个人都顶着黑眼圈。", "effects": [ { "op": "SET_FLAG", "key": "order", "v": 1 } ] } ] },
      { "label": "加薪志愿", "outcomes": [ { "p": 1.0, "text": "重赏之下，岗哨满了。", "effects": [ { "op": "ADD_GOLD", "n": -400 }, { "op": "GRANT_BUFF", "buff": "paidwatch", "days": 3 } ] } ] },
      { "label": "主角顶班", "outcomes": [ { "p": 1.0, "text": "你打着哈欠守到天亮，威望涨了。", "effects": [ { "op": "SET_FLAG", "key": "mood", "v": 1 } ] } ] } ] },
    { "id": "evt_pet_020", "ver": 1, "type": "choice", "title": "宠物医院", "weight": 50, "cooldownDays": 14, "maxPerRun": 2, "prereq": {}, "text": "药店的金毛难产，主人跪在地上求救。", "options": [
      { "label": "急救", "outcomes": [ { "p": 1.0, "text": "五只崽子活了下来，母犬成了编外保安。", "effects": [ { "op": "ADD_RES", "res": "material", "n": -150 }, { "op": "SET_FLAG", "key": "mood", "v": 1 } ] } ] },
      { "label": "放弃", "outcomes": [ { "p": 1.0, "text": "哀嚎了一整夜。", "effects": [ { "op": "ADD_PANIC", "n": 4 } ] } ] } ] },
    { "id": "evt_yoga_021", "ver": 1, "type": "choice", "title": "天台的富婆", "weight": 60, "cooldownDays": 14, "maxPerRun": 2, "prereq": { "dayMin": 7 }, "text": "天台上有人在做瑜伽，瑜伽垫是爱马仕的。", "options": [
      { "label": "收高额租", "outcomes": [ { "p": 1.0, "text": "她眼都没眨就付了。", "effects": [ { "op": "ADD_GOLD", "n": 1500 } ] } ] },
      { "label": "请她教理财", "outcomes": [ { "p": 1.0, "text": "她笑：「有点意思。」", "effects": [ { "op": "SET_FLAG", "key": "laiScore", "v": 1 } ] } ] },
      { "label": "无视", "outcomes": [ { "p": 1.0, "text": "她做完一组拜日式就走了。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": 0 } ] } ] } ] },
    { "id": "evt_blackout_022", "ver": 1, "type": "choice", "title": "停电夜", "weight": 65, "cooldownDays": 10, "maxPerRun": 2, "prereq": {}, "text": "整栋楼陷入黑暗，走廊里全是摸索的声音。", "options": [
      { "label": "点蜡烛", "outcomes": [ { "p": 1.0, "text": "烛光摇曳，人心也跟着晃。", "effects": [ { "op": "ADD_GOLD", "n": -100 }, { "op": "ADD_PANIC", "n": 3 } ] } ] },
      { "label": "发电机全开", "outcomes": [ { "p": 1.0, "text": "轰鸣声里，灯全亮了。", "effects": [ { "op": "ADD_RES", "res": "material", "n": -100 }, { "op": "ADD_PANIC", "n": -6 } ] } ] },
    ...
    { "id": "evt_love_023", "ver": 1, "type": "choice", "title": "地下室的婚礼", "weight": 55, "cooldownDays": 14, "maxPerRun": 2, "prereq": {}, "text": "地下室一对年轻人要成婚，想借一楼办仪式。", "options": [
      { "label": "成全", "outcomes": [ { "p": 1.0, "text": "糖果是糖纸折的，掌声是真的。", "effects": [ { "op": "SET_FLAG", "key": "mood", "v": 1 }, { "op": "SET_FLAG", "key": "reputation", "v": 1 } ] } ] },
      { "label": "棒打鸳鸯", "outcomes": [ { "p": 1.0, "text": "姑娘哭了一夜，楼里指指点点。", "effects": [ { "op": "ADD_PANIC", "n": 8 } ] } ] },
      { "label": "收礼金", "outcomes": [ { "p": 1.0, "text": "场地费照收，骂声照来。", "effects": [ { "op": "ADD_GOLD", "n": 300 }, { "op": "SET_FLAG", "key": "reputation", "v": -1 } ] } ] } ] },
    { "id": "evt_tycoon_024", "ver": 1, "type": "choice", "title": "富商求庇护", "weight": 65, "cooldownDays": 14, "maxPerRun": 2, "prereq": { "dayMin": 8 }, "text": "西装男人带着两个行李箱：「我能付。」", "options": [
      { "label": "收十金入伙", "outcomes": [ { "p": 1.0, "text": "行李箱里是金条和罐头。", "effects": [ { "op": "ADD_GOLD", "n": 1000 } ] } ] },
      { "label": "免费庇护", "outcomes": [ { "p": 1.0, "text": "「好人呐！」全楼传颂。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": 2 } ] } ] },
      { "label": "拒绝", "outcomes": [ { "p": 1.0, "text": "他消失在夜色里。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": 0 } ] } ] } ] },
    ...
    { "id": "evt_mis_101", "ver": 1, "type": "mission", "title": "7 楼老太被困", "weight": 100, "cooldownDays": 7, "maxPerRun": 2, "prereq": { "dayMin": 3 }, "text": "7 楼传来说不清是人是物的撞击声——被困的老太太还在里面。", "options": [
      ...
      { "label": "放弃", "outcomes": [ { "p": 1.0, "text": "撞击声停了。整栋楼安静得可怕。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": -1 } ] } ] } ] },
    { "id": "evt_mis_102", "ver": 1, "type": "mission", "title": "药房突袭", "weight": 70, "cooldownDays": 10, "maxPerRun": 2, "prereq": { "dayMin": 4 }, "text": "街角药房的卷帘门半开，里面应该还有存货。", "options": [
      { "label": "亲自带队", "outcomes": [ { "p": 1.0, "text": "药品和弹药装了两大包，有人挂彩。", "effects": [ { "op": "ADD_RES", "res": "material", "n": 200 }, { "op": "ADD_RES", "res": "ammo", "n": 100 }, { "op": "WOUND_TENANT", "tenantId": -1 } ] } ] },
      { "label": "派守卫去", "outcomes": [ { "p": 1.0, "text": "稳字当头，收获打了折。", "effects": [ { "op": "ADD_RES", "res": "material", "n": 100 } ] } ] },
      { "label": "放弃", "outcomes": [ { "p": 1.0, "text": "机会只有一次。", "effects": [ { "op": "SET_FLAG", "key": "intel", "v": -1 } ] } ] } ] },
    { "id": "evt_mis_103", "ver": 1, "type": "mission", "title": "超市清场", "weight": 70, "cooldownDays": 10, "maxPerRun": 2, "prereq": {}, "text": "连锁超市的卷帘门里传来此起彼伏的低吼。", "options": [
      { "label": "搜刮", "outcomes": [ { "p": 1.0, "text": "食品和瓶装水搬空了两排货架，有人被划伤。", "effects": [ { "op": "ADD_RES", "res": "food", "n": 300 }, { "op": "ADD_RES", "res": "water", "n": 200 }, { "op": "WOUND_TENANT", "tenantId": -1 } ] } ] },
      { "label": "保守清点", "outcomes": [ { "p": 1.0, "text": "只拿了门口顺手的。", "effects": [ { "op": "ADD_RES", "res": "food", "n": 120 } ] } ] } ] },
    { "id": "evt_mis_104", "ver": 1, "type": "mission", "title": "五金店建材", "weight": 60, "cooldownDays": 10, "maxPerRun": 2, "prereq": { "dayMin": 5 }, "text": "五金店老板跑了，货架上一排排角钢还在。", "options": [
      { "label": "满载而归", "outcomes": [ { "p": 1.0, "text": "角钢、螺丝、门铰链，全是硬货。", "effects": [ { "op": "ADD_RES", "res": "material", "n": 400 } ] } ] },
      { "label": "快撤", "outcomes": [ { "p": 1.0, "text": "只抢了手边的。", "effects": [ { "op": "ADD_RES", "res": "material", "n": 150 } ] } ] } ] },
    { "id": "evt_mis_105", "ver": 1, "type": "mission", "title": "加油站取油", "weight": 60, "cooldownDays": 12, "maxPerRun": 2, "prereq": { "dayMin": 6 }, "text": "加油站的储油罐还有余油，就是守着它的东西不太友好。", "options": [
      { "label": "取油", "outcomes": [ { "p": 1.0, "text": "三大桶柴油，顺便拆了两个燃烧瓶，有人被烫伤。", "effects": [ { "op": "ADD_RES", "res": "ammo", "n": 80 }, { "op": "WOUND_TENANT", "tenantId": -1 } ] } ] },
      { "label": "放弃", "outcomes": [ { "p": 1.0, "text": "油罐的呼吸孔传来刮擦声。", "effects": [ { "op": "ADD_PANIC", "n": 3 } ] } ] } ] },
    { "id": "evt_mis_106", "ver": 1, "type": "mission", "title": "收容流浪者", "weight": 65, "cooldownDays": 10, "maxPerRun": 2, "prereq": { "dayMin": 4 }, "text": "高架桥下蜷着几个幸存者，眼神警惕。", "options": [
      { "label": "收容队", "outcomes": [ { "p": 1.0, "text": "带回了几个人，食堂压力大了。", "effects": [ { "op": "SPAWN_TENANT", "quality": "N" }, { "op": "SPAWN_TENANT", "quality": "N" } ] } ] },
      { "label": "劝走", "outcomes": [ { "p": 1.0, "text": "他们朝另一个方向去了。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": 0 } ] } ] } ] },
    { "id": "evt_mis_107", "ver": 1, "type": "mission", "title": "医院废墟", "weight": 50, "cooldownDays": 14, "maxPerRun": 2, "prereq": { "dayMin": 8 }, "text": "市医院的废墟里据说还有一位没走的护士长。", "options": [
      ...
      { "label": "外围捡漏", "outcomes": [ { "p": 1.0, "text": "边缘柜台扫了一些药品。", "effects": [ { "op": "ADD_RES", "res": "material", "n": 120 } ] } ] } ] },
    { "id": "evt_mis_108", "ver": 1, "type": "mission", "title": "学校避难所", "weight": 55, "cooldownDays": 14, "maxPerRun": 2, "prereq": { "dayMin": 8 }, "text": "小学体育馆里有二十几个幸存者，只收得下几个。", "options": [
      { "label": "接纳", "outcomes": [ { "p": 1.0, "text": "来了老师带着两个孩子，楼里多了人气也多了嘴。", "effects": [ { "op": "SPAWN_TENANT", "quality": "N" }, { "op": "SPAWN_TENANT", "quality": "N" }, { "op": "SET_FLAG", "key": "reputation", "v": 1 } ] } ] },
      { "label": "拒收", "outcomes": [ { "p": 1.0, "text": "铁门在他们身后关闭。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": -1 } ] } ] } ] },
    { "id": "evt_mis_109", "ver": 1, "type": "mission", "title": "银行金库", "weight": 45, "cooldownDays": 14, "maxPerRun": 2, "prereq": { "dayMin": 10 }, "text": "银行地下金库的电子锁还剩最后一道——里面是传说中的金条。", "options": [
      { "label": "撬库", "outcomes": [ { "p": 1.0, "text": "金条到手！但动静引来了怪物的增援潮。", "effects": [ { "op": "ADD_GOLD", "n": 2500 }, { "op": "NIGHT_MOD", "mod": "SILENT" } ] } ] },
      { "label": "放弃", "outcomes": [ { "p": 1.0, "text": "金库的门在身后缓缓合上。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": 0 } ] } ] } ] },
    { "id": "evt_mis_110", "ver": 1, "type": "mission", "title": "高速路撤离车队", "weight": 60, "cooldownDays": 14, "maxPerRun": 2, "prereq": { "dayMin": 9 }, "text": "撤离车队抛锚在高架上，人愿意付钱换一个铺位。", "options": [
      { "label": "接应收人", "outcomes": [ { "p": 1.0, "text": "每人 200 金币，来了五个付费租客。", "effects": [ { "op": "ADD_GOLD", "n": 1000 }, { "op": "SPAWN_TENANT", "quality": "N" }, { "op": "SPAWN_TENANT", "quality": "N" } ] } ] },
      { "label": "驱赶", "outcomes": [ { "p": 1.0, "text": "车队的灯光在夜里远去。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": -1 } ] } ] } ] },

    { "id": "evt_ord_201", "ver": 1, "type": "choice", "title": "楼道争吵", "weight": 60, "cooldownDays": 7, "maxPerRun": 2, "prereq": {}, "text": "五楼两户为了楼道堆物吵到了动手的边缘。", "options": [
      { "label": "调解", "outcomes": [ { "p": 1.0, "text": "各退一步，楼道重新通畅。", "effects": [ { "op": "ADD_PANIC", "n": -4 } ] } ] },
      { "label": "各打五十大板", "outcomes": [ { "p": 1.0, "text": "罚了两家清扫，秩序立了，怨气也存了。", "effects": [ { "op": "SET_FLAG", "key": "order", "v": 1 }, { "op": "SET_FLAG", "key": "mood", "v": -1 } ] } ] },
      { "label": "冷处理", "outcomes": [ { "p": 1.0, "text": "争吵升级成了对骂。", "effects": [ { "op": "ADD_PANIC", "n": 4 } ] } ] } ] },
    { "id": "evt_ord_202", "ver": 1, "type": "choice", "title": "藏粮与挨饿的孩子", "weight": 70, "cooldownDays": 12, "maxPerRun": 2, "prereq": { "panicMin": 40 }, "text": "有人囤粮，隔壁的孩子却饿得哭不出声。", "options": [
      { "label": "搜查", "outcomes": [ { "p": 1.0, "text": "囤粮充公，囤粮者被扫地出门。", "effects": [ { "op": "ADD_RES", "res": "food", "n": 300 }, { "op": "ADD_PANIC", "n": 6 }, { "op": "SET_FLAG", "key": "order", "v": 1 } ] } ] },
      { "label": "接济", "outcomes": [ { "p": 1.0, "text": "自家的米缸见底了，但孩子吃饱了。", "effects": [ { "op": "ADD_RES", "res": "food", "n": -200 }, { "op": "ADD_PANIC", "n": -6 } ] } ] },
      { "label": "不管", "outcomes": [ { "p": 1.0, "text": "哭声持续到后半夜。", "effects": [ { "op": "ADD_PANIC", "n": 10 } ] } ] } ] },
    { "id": "evt_ord_203", "ver": 1, "type": "choice", "title": "自发巡逻队", "weight": 60, "cooldownDays": 12, "maxPerRun": 2, "prereq": { "dayMin": 6 }, "text": "几个年轻人自发组织了夜间巡逻。", "options": [
      { "label": "支持", "outcomes": [ { "p": 1.0, "text": "巡逻队的臂章是用红布条做的。", "effects": [ { "op": "GRANT_BUFF", "buff": "patrol", "days": 5 } ] } ] },
      { "label": "发工资收编", "outcomes": [ { "p": 1.0, "text": "给钱才有执行力，但确实管用。", "effects": [ { "op": "ADD_GOLD", "n": -500 }, { "op": "GRANT_BUFF", "buff": "patrolPaid", "days": 7 } ] } ] },
      { "label": "解散", "outcomes": [ { "p": 1.0, "text": "巡逻队散了，夜里的脚步声多了。", "effects": [ { "op": "ADD_PANIC", "n": 5 } ] } ] } ] },
    { "id": "evt_ord_204", "ver": 1, "type": "choice", "title": "「收租鬼」涂鸦", "weight": 55, "cooldownDays": 12, "maxPerRun": 2, "prereq": {}, "text": "外墙上被人喷了三个大红字：收租鬼。", "options": [
      { "label": "清洗", "outcomes": [ { "p": 1.0, "text": "漆没洗干净，字还在。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": 0 } ] } ] },
      { "label": "默许", "outcomes": [ { "p": 1.0, "text": "年轻人觉得这称呼挺酷。", "effects": [ { "op": "SET_FLAG", "key": "mood", "v": 1 } ] } ] },
      { "label": "反向营销", "outcomes": [ { "p": 1.0, "text": "「收租鬼保护费」的段子传遍了避难所圈子。", "effects": [ { "op": "ADD_GOLD", "n": 200 } ] } ] } ] },
    { "id": "evt_ord_205", "ver": 1, "type": "choice", "title": "逝者葬礼", "weight": 65, "cooldownDays": 14, "maxPerRun": 2, "prereq": { "dayMin": 7 }, "text": "死者的家属想办一场像样的葬礼。", "options": [
      { "label": "办仪式", "outcomes": [ { "p": 1.0, "text": "白花是用纸巾折的，哀乐是口琴吹的。", "effects": [ { "op": "ADD_RES", "res": "food", "n": -150 }, { "op": "SET_FLAG", "key": "mood", "v": 1 } ] } ] },
      { "label": "从简", "outcomes": [ { "p": 1.0, "text": "一个坑，一块木板。", "effects": [ { "op": "SET_FLAG", "key": "mood", "v": -1 } ] } ] },
      { "label": "研究尸体", "outcomes": [ { "p": 1.0, "text": "伤口的齿痕记录进了怪物图鉴。", "effects": [ { "op": "SET_FLAG", "key": "intel", "v": 1 }, { "op": "ADD_PANIC", "n": 6 } ] } ] } ] },
    { "id": "evt_ord_206", "ver": 1, "type": "choice", "title": "公约投票：宵禁", "weight": 70, "cooldownDays": 14, "maxPerRun": 2, "prereq": { "dayMin": 5, "flags": { "orderIntro": 1 } }, "text": "议事厅贴出告示：是否实行宵禁，全楼投票。", "options": [
      { "label": "通过", "outcomes": [ { "p": 1.0, "text": "宵禁令下，夜里再无人走动。", "effects": [ { "op": "SET_FLAG", "key": "curfew", "v": 1 }, { "op": "SET_FLAG", "key": "mood", "v": -1 } ] } ] },
      { "label": "否决", "outcomes": [ { "p": 1.0, "text": "自由万岁——忧患派摇了摇头。", "effects": [ { "op": "SET_FLAG", "key": "mood", "v": 1 } ] } ] },
      { "label": "折中", "outcomes": [ { "p": 1.0, "text": "宵禁到十点，大家都能接受。", "effects": [ { "op": "SET_FLAG", "key": "curfew", "v": 2 } ] } ] } ] },
    { "id": "evt_ord_207", "ver": 1, "type": "choice", "title": "公区大扫除", "weight": 55, "cooldownDays": 12, "maxPerRun": 2, "prereq": {}, "text": "楼道积灰，电梯口的杂物堆了半人高。", "options": [
      { "label": "全员动员", "outcomes": [ { "p": 1.0, "text": "大扫除后楼里亮堂了，人心也亮堂了。", "effects": [ { "op": "ADD_PANIC", "n": -6 } ] } ] },
      { "label": "雇人打扫", "outcomes": [ { "p": 1.0, "text": "花钱买清净。", "effects": [ { "op": "ADD_GOLD", "n": -250 }, { "op": "ADD_PANIC", "n": -4 } ] } ] },
      { "label": "自己上", "outcomes": [ { "p": 1.0, "text": "你扫了一下午，腰都直不起来。", "effects": [ { "op": "SET_FLAG", "key": "mood", "v": 1 } ] } ] } ] },
    { "id": "evt_ord_208", "ver": 1, "type": "choice", "title": "生面孔混入", "weight": 65, "cooldownDays": 10, "maxPerRun": 2, "prereq": { "dayMin": 5 }, "text": "电梯里出现了没见过的面孔，谁也说不清来历。", "options": [
      ...
      { "label": "放行", "outcomes": [ { "p": 1.0, "text": "也许只是个借宿的。", "effects": [ { "op": "SET_FLAG", "key": "reputation", "v": 1 } ] } ] },
      { "label": "收编考察", "outcomes": [ { "p": 1.0, "text": "留用察看，干活都多了一份心眼。", "effects": [ { "op": "SPAWN_TENANT", "quality": "N" } ] } ] } ] }
  ]
}
,
  monster: {
